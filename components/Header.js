...
import { GlobeAltIcon, MenuIcon, UserCircleIcon, UsersIcon, SearchIcon, ChevronLeftIcon } from '@heroicons/react/solid'
...
function Header({ placeholder }) {
    ...
    return (
        <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
            ...
            {/* right */}
            <div className="hidden sm:inline-flex items-center space-x-4 justify-end text-gray-500 ">
